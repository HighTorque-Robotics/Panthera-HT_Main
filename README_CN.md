...
| **[Panthera-HT_SDK](https://github.com/HighTorque-Robotics/Panthera-HT_SDK/tree/main/2_Panthera-HT_SDK)**     | [MIT](LICENSE) | Python SDK 开发包，提供快速上手的示例代码与开发工具链。 |
| **[Panthera-HT_ROS2](https://github.com/HighTorque-Robotics/Panthera-HT-ROS2)**                               | [MIT](LICENSE) | ROS2 开发包，提供机械臂的驱动、控制与仿真支持。         |
| **[Panthera-HT_Model](https://github.com/HighTorque-Robotics/Panthera-HT_SDK/tree/main/1_Panthera-HT_Model)** | [MIT](LICENSE) | SolidWorks原始设计文件和物料清单（BOM）。               |
